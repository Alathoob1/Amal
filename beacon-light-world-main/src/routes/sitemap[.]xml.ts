...
const paths = [
  ...
  { path: "/ai-analysis", priority: "0.9", changefreq: "monthly" as const },
  { path: "/dashboard", priority: "0.7", changefreq: "weekly" as const },
  { path: "/community", priority: "0.8", changefreq: "weekly" as const },
  { path: "/knowledge", priority: "0.8", changefreq: "weekly" as const },
  { path: "/places", priority: "0.8", changefreq: "weekly" as const },
